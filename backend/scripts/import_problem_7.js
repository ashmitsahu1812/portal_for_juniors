...
const seedNewProblem = async () => {
  try {
    ...
    const newProblem = new Problem({
      ...
      title: "Call GCD Function",
      description: `Write a program that reads two large integers, $a$ and $b$, from the standard input (each on a separate line) and calculates their Greatest Common Divisor (GCD). 
...
The Greatest Common Divisor of two integers is the largest positive integer that divides both numbers without leaving a remainder.`,
      ...
      tags: ['Python Function', 'Math Operations'],
      timeLimitSeconds: 2,
      memoryLimitMB: 256,
      isPublished: true,
      testCases: [
